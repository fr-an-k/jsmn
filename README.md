...
This assumes a maximum depth of JSMN_MAX_FAST_DEPTH (default 64):
...
r = jsmn_parse(&p, s, strlen(s), t, 128); // "s" is the char array holding the
json content
```

Or if you want to dynamically determine max_depth and allocate toksupers
